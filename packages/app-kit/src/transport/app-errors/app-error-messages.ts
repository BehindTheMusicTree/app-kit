...
/**
 * Reads a caller-supplied contact email (e.g. `process.env.NEXT_PUBLIC_CONTACT_EMAIL` in the
 * consuming app) rather than a hardcoded env var name, so this package stays app-agnostic.
 */
export function getSpotifyAllowlistMailtoHref(contactEmail: string | null | undefined): string | null {
